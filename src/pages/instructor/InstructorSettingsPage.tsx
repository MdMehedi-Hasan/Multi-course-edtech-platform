  ...
  return (
    <div className="space-y-8 max-w-3xl">
      ...
      <div className="pb-6 border-b border-slate-200">
        <h1 className="text-2xl font-black text-slate-900">Instructor Settings & Security</h1>
      ...
      <Card className="p-6 border-slate-200 space-y-4">
        <h2 className="text-sm font-extrabold text-slate-900 flex items-center gap-2">
          <Bell className="w-4 h-4 text-indigo-600" /> Email Notifications
        </h2>

        <div className="space-y-3 text-xs">
          <label className="flex items-center justify-between p-3 bg-slate-50 rounded-xl border border-slate-200 cursor-pointer">
            <div>
              <p className="font-bold text-slate-900">New Student Enrollments</p>
              <p className="text-[10px] text-slate-500">Receive an instant email when a student purchases your course.</p>
            </div>
            <input
              type="checkbox"
          ...
          <label className="flex items-center justify-between p-3 bg-slate-50 rounded-xl border border-slate-200 cursor-pointer">
            <div>
              <p className="font-bold text-slate-900">Course Reviews & Feedback</p>
              <p className="text-[10px] text-slate-500">Get notified when a student submits a review on your course.</p>
            </div>
            <input
              type="checkbox"
          ...
          <label className="flex items-center justify-between p-3 bg-slate-50 rounded-xl border border-slate-200 cursor-pointer">
            <div>
              <p className="font-bold text-slate-900">Platform & Feature Updates</p>
              <p className="text-[10px] text-slate-500">Receive monthly newsletter regarding instructor platform enhancements.</p>
            </div>
            <input
              type="checkbox"
