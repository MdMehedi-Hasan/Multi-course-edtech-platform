    ...
    <div className="space-y-8 max-w-3xl">
      ...
      <div className="flex items-center justify-between pb-6 border-b border-slate-700/50">
        <div>
          ...
          <h1 className="text-2xl font-black text-slate-100">Create New Course Draft</h1>
        ...
        <form onSubmit={handleCreateCourse} className="space-y-5">
          <div>
            ...
            <input
              ...
              className="w-full bg-slate-900/60 text-slate-100 p-3 text-xs rounded-xl border border-slate-700/50 focus:outline-none focus:border-indigo-500/40 font-bold"
            />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div>
              ...
              >
                {categories.map((cat) => (
                  <option className="bg-slate-900 text-slate-100" key={cat.id} value={cat.id}>
                    {cat.name}
                  </option>
                ))}
              </select>
