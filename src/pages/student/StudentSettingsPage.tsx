  ...
  return (
    <div className="space-y-8 max-w-3xl">
      ...
      <div className="pb-6 border-b border-slate-200">
        <h1 className="text-2xl font-black text-slate-900">Account & Security Settings</h1>
        <p className="text-xs text-slate-500 mt-1">Manage credentials, password updates, and notification settings.</p>
      </div>
      ...
      <Card className="p-6 border-slate-200 space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
          <div className="p-3 bg-slate-50 rounded-xl border border-slate-100">
            <span className="text-[10px] font-bold uppercase tracking-wider text-slate-400">Primary Email</span>
            <p className="font-bold text-slate-900 mt-0.5">{user?.email}</p>
          </div>
          <div className="p-3 bg-slate-50 rounded-xl border border-slate-100">
            <span className="text-[10px] font-bold uppercase tracking-wider text-slate-400">Account Role</span>
            <p className="font-bold text-indigo-600 mt-0.5">{user?.role}</p>
          </div>
        </div>
      </Card>
      ...
      <Card className="p-6 border-slate-200 space-y-4">
        <h2 className="text-sm font-extrabold text-slate-900 flex items-center gap-2">
          <BellRing className="w-4 h-4 text-indigo-600" /> Email Notifications
        </h2>

        <div className="space-y-3 divide-y divide-slate-100 text-xs">
          <div className="flex items-center justify-between pt-2">
            <div>
              <p className="font-bold text-slate-900">Course & Lesson Announcements</p>
              <p className="text-[11px] text-slate-500">Receive email alerts for new course modules and updates.</p>
            </div>
            <input
              type="checkbox"
          ...
          <div className="flex items-center justify-between pt-3">
            <div>
              <p className="font-bold text-slate-900">Promotional & Catalog Updates</p>
              <p className="text-[11px] text-slate-500">Receive special discount offers and new category additions.</p>
            </div>
            <input
              type="checkbox"
